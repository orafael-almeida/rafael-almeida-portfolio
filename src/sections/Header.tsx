...
const Header = () => {
  return (
    <header className="flex justify-between items-center fixed top-3 w-full px-4 md:px-16 lg:px-32 z-50">
      <div>
      <Logo className="hidden sm:size-8 " />
      </div>
      <nav className="flex md:gap-1 p-0.5 border rounded-full border-gray-900/60 bg-gray-200/40 dark:border-white/15 dark:bg-white/10 backdrop-blur">
        <a href="#home" className="nav-item text-gray-900 dark:text-slate-200">
          Home
        </a>
        <a href="#projects" className="nav-item text-gray-900 dark:text-slate-200">
          Projetos
        </a>
        <a href="#about" className="nav-item text-gray-900 dark:text-slate-200">
          Sobre
        </a>
        <a href="#contact" className="nav-item text-gray-900 dark:text-slate-200">
          Contato
        </a>
      </nav>
